...
import os
import urllib2
jenkins_dev_work_wsf_path = '/data/jenkins/workspace/eflower-html-z-dev/source_code/z'
jenkins_dev_cp_wsf_path = '/data/jenkins/workspace/eflower-html-z-dev/source_code/z/z'
dev_html_253 = '/data/devtest/apache2/htdocs/z'
...
curl_test = 'http://xxx.xxx.com/z/#/income'
